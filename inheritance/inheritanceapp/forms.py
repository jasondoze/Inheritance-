...
# NOTICE NEED TO ADD MAX LENGTH TO EACH/ALL FORMS PER PERTINENT ATTRIBUTE FOR STANDARDIZED CRITERIA

class ImageForm(forms.ModelForm):
    """Form for the image model"""

    imgtitle = forms.CharField(label=False, max_length=13, widget=forms.TextInput(attrs={"placeholder": "  enter title", "class": "control-the-form"}))
    imgdesc = forms.CharField(label=False, max_length=24, widget=forms.TextInput(attrs={"placeholder": "  enter description", "class": "control-the-form"}))
...
class EditorForm(forms.Form):
    ...
    imgdesc = forms.CharField(widget=forms.Textarea(attrs={'placeholder': 'add description'}), label=False, required=True, max_length=24)
